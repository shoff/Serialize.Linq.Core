namespace Serialize.Linq.Core.Extensions
{
    using System;
    ...
    public static class ExpressionExtensions
    {
        ...
        internal static IEnumerable<Expression> GetLinkNodes(this Expression expression)
        {
            ...
            else if (expression is ListInitExpression initExpression)
            {
                yield return initExpression.NewExpression;
            }
        ...
        /// <param name="expression">The expression.</param>
        /// <returns></returns>
        internal static IEnumerable<TExpression> GetNodes<TExpression>(this Expression expression)
