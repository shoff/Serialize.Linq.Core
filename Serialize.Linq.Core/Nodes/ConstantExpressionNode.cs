    ...
    public class ConstantExpressionNode : ExpressionNode<ConstantExpression>
    {
        ...
        public object Value
        {
            ...
            set
            {
                ...
                if (value is Type)
                {
                    this._value = this.Factory.Create(value as Type);
                }
                else
                {
                    this._value = value;
                ...
                if (this._value == null || this._value is TypeNode)
                {
                    return;
                }
                ...
                if (type == null)
                {
                    ...
                    {
                        base.Type = this.Factory.Create(this._value.GetType());
                    }

                    return;
                }
                this._value = ValueConverter.Convert(this._value, type);
            }
        }
